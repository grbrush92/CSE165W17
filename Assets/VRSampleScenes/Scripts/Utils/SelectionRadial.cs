...
namespace VRStandardAssets.Utils
{
    ...
    public class SelectionRadial : MonoBehaviour
    {
        ...
        [SerializeField]
        private VRInteractiveItem m_Interactive;                                                // Reference to the VRInput so that input events can be subscribed to.
        ...
        private void OnEnable()
        {
            ...
            m_Interactive.OnOver += HandleOver;
            m_Interactive.OnOut += HandleOut;
        }
        ...
        {
            Debug.Log("filling selection radial");
        ...
        {
            Debug.Log("Selection Radial: Handle Over");
